...
const FAQ_ITEMS = [
  ...
  {
    question: "Как работает импорт резервной копии?",
    answer:
      "Импорт в настройках загружает JSON-файл резервной копии и заменяет текущие данные приложения: финансы, слот-сессии, избранное, свои слоты и настройки.",
  },
  {
